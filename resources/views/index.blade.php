...
<div id="page" class="site">
        ...
        <div class="grid">
            ...
            <div class="grid__item large--one-half text-right">
                <div class="hdt-account">
                    <a href="{{ route('admin') }}">Đăng nhập</a>
                    <a href="#">Đăng ký</a>
                </div>
    ...
    <div class="search-bar-header">
        <div class="search-form-wrapper">
            <form id="searchauto" method="post" class="searchform-categoris ultimate-search" action="{{ route('postSearch') }}">
            @csrf
                <div class="wpo-search">
                    <div class="wpo-search-inner">
                        <div class="input-group">
                            <input type="hidden" name="post-type" value="product">
                            <input type="text" id="searchtext" class="form-control input-search" placeholder="Search &hellip;" value="{{ request('s') }}" name="s" />
                        ...
                        @if ($errors->has('s'))
                            <div class="text-danger mt-2">{{ $errors->first('s') }}</div>
                        @endif
                    </div>
            	...
            	<div class="wrapper">
                	<div class="inner">
                        ...
                        <div class="section-content">
							                            <div class="tab">
                                                            <button id="defaultOpenTab" class="tablinks active" onclick="openTabs(event,'tab_20')">Hoa quả</button>
                                                            <button  class="tablinks " onclick="openTabs(event,'tab_21')">Thực phẩm khô</button>
                                                            <button  class="tablinks " onclick="openTabs(event,'tab_19')">Rau hữu cơ</button>
                                                        </div>
            ...
            <div class="md-pd-left10 grid__item large--one-quarter medium--one-third small--one-half">
                <div class="product-item">
                    <div class="product-img">
                        <a href="#">
                            <img width="260px" height="260px" src="{{ asset($listfood->image) }}" class="attachment-thumb_260x260 size-thumb_260x260 wp-post-image" alt="{{ $listfood->name }}" />
                        </a>
                    </div>
                    <div class="product-info">
                        <div class="product-title">
                            <a href="#">{{ $listfood->name }}</a>
                        </div>
                        <div class="product-price clearfix">
                            <span class="current-price"><span class="woocommerce-Price-amount amount">{{ number_format($listfood->price, 0, ',', '.') }}<span class="woocommerce-Price-currencySymbol">&#8363;</span></span></span>
                        </div>
                        <div class="product-actions text-center clearfix">
                            <a href="{{ route('foods.show', $listfood->id )}}">
                                <button type="button" class="btn-buyNow buy-now medium--hide small--hide">Chi tiết</button>
                	...
                	<div class="wrapper">
						<div class="inner">
                        	<div class="gallery-slider grid">
                                        ...
                                        <a href="https://at10.mediawz.com/wp-content/uploads/2019/06/hg_1.jpg" class="fancybox" data-fancybox="home-gallery-images" data-fancybox-group="gallery664c183a672ec" data-caption="gallery 1">
                                            <img src="https://at10.mediawz.com/wp-content/uploads/2019/06/hg_1-360x255.jpg" alt="">
                                            <div class="overlay"></div>
                                        </a>
                                    </div>
								 									<div class="gallery-item grid__item">
                                        <a href="https://at10.mediawz.com/wp-content/uploads/2019/06/hg_2.jpg" class="fancybox" data-fancybox="home-gallery-images" data-fancybox-group="gallery664c183a672ec" data-caption="gallery 1">
                                            <img src="https://at10.mediawz.com/wp-content/uploads/2019/06/hg_2-360x255.jpg" alt="">
                                            <div class="overlay"></div>
                                        </a>
                                    </div>
								 									<div class="gallery-item grid__item">
                                        <a href="https://at10.mediawz.com/wp-content/uploads/2019/06/hg_4.jpg" class="fancybox" data-fancybox="home-gallery-images" data-fancybox-group="gallery664c183a672ec" data-caption="gallery 1">
                                            <img src="https://at10.mediawz.com/wp-content/uploads/2019/06/hg_4-360x255.jpg" alt="">
                                            <div class="overlay"></div>
                                        </a>
                                    </div>
								 									<div class="gallery-item grid__item">
                                        <a href="https://at10.mediawz.com/wp-content/uploads/2019/06/hg_5.jpg" class="fancybox" data-fancybox="home-gallery-images" data-fancybox-group="gallery664c183a672ec" data-caption="gallery 1">
...
<li id="menu-item-65" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-65"><a href="https://at10.mediawz.com/huong-dan-mua-hang/">Hướng dẫn mua hàng</a></li>
					...
					<h3 class="footer-title">GALLERY</h3>					<div class="grid gallery-wrapper mg-left-15">
                                ...
                                <div class="gallery-item">
                                    <a href="https://at10.mediawz.com/wp-content/uploads/2019/06/ms_banner_img3.jpg" class="fancybox" data-fancybox="home-gallery-images" data-fancybox-group="gallery664c183a6bb1c" data-caption="gallery 1">
                                        ...
                                        <div class="overlay"></div>
                                                  	...
                                                  	<div class=" grid__item large--one-third medium--one-third small--one-third  pd-left15">
                                <div class="gallery-item">
                                    <a href="https://at10.mediawz.com/wp-content/uploads/2019/06/ms_banner_img2.jpg" class="fancybox" data-fancybox="home-gallery-images" data-fancybox-group="gallery664c183a6bb1c" data-caption="gallery 1">
                                        ...
                                        <div class="overlay"></div>
                                                  	...
                                                  	<div class=" grid__item large--one-third medium--one-third small--one-third  pd-left15">
                                <div class="gallery-item">
                                    <a href="https://at10.mediawz.com/wp-content/uploads/2019/06/ms_banner_img1.jpg" class="fancybox" data-fancybox="home-gallery-images" data-fancybox-group="gallery664c183a6bb1c" data-caption="gallery 1">
